...
rtl.module("program",["System","JS","Web"],function () {
  ...
  this.BuildWebsite = function () {
    ...
    homeP.textContent = "Rushikes & Co. is engaged in providing chartered accounting services, financial and consultancy services, internal auditing, and corporate services.";
    ...
    aboutP.textContent = "Rushikes & Co. firm is formed by 4 professionals who have diverse experience in their respective areas of practice. Our objective is to enhance the prospects of our clients.";
    aboutMissionDiv = $mod.CreateElementWithClass("div","mission-box");
    missionH3 = document.createElement("h3");
    missionH3.textContent = "Our Mission";
    missionP = document.createElement("p");
    missionP.textContent = 'To provide "One Stop Solutions" to our clients, combining technical expertise with personalized service.';
    aboutMissionDiv.appendChild(missionH3);
    aboutMissionDiv.appendChild(missionP);
    aboutDiv.appendChild(aboutH2);
    aboutDiv.appendChild(aboutP);
    aboutDiv.appendChild(aboutMissionDiv);
    ...
    yearSpan.innerHTML = "© 2025 Rushikes & Co. All rights reserved.";
    footer.appendChild(yearSpan);
    document.body.appendChild(footer);
    style = document.createElement("style");
    style.textContent = "* { margin: 0; padding: 0; box-sizing: border-box; } " + 'body { font-family: "Segoe UI", Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; } ' + ".site-header { background: #1a2a3a; position: fixed; width: 100%; top: 0; z-index: 1000; } " + ".nav-container { max-width: 1200px; margin: 0 auto; padding: 1rem; text-align: center; } " + ".nav-links a { color: white; text-decoration: none; margin: 0 15px; font-weight: 500; transition: color 0.3s; cursor: pointer; } " + ".nav-links a:hover { color: #ffd700; } " + "section { padding: 80px 20px; min-height: 100vh; display: flex; align-items: center; } " + ".hero-section { background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); text-align: center; } " + ".hero-content { max-width: 800px; margin: 0 auto; } " + ".hero-content h1 { font-size: 3rem; margin-bottom: 1rem; color: #1a2a3a; } " + ".highlight { color: #c0392b; } " + ".hero-content p { font-size: 1.2rem; margin-bottom: 2rem; } " + ".btn-primary { display: inline-block; background: #c0392b; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; transition: background 0.3s; border: none; cursor: pointer; font-size: 1rem; } " + ".btn-primary:hover { background: #a93226; } " + ".about-section { background: white; } " + ".container { max-width: 1200px; margin: 0 auto; text-align: center; } " + ".about-section h2, .contact-section h2 { font-size: 2.5rem; margin-bottom: 2rem; color: #1a2a3a; } " + ".about-section p { font-size: 1.1rem; margin-bottom: 2rem; max-width: 800px; margin-left: auto; margin-right: auto; } " + ".mission-box { background: #f8f9fa; padding: 2rem; border-radius: 8px; max-width: 600px; margin: 2rem auto; } " + ".contact-section { background: #f5f7fa; } " + ".contact-section form { max-width: 600px; margin: 0 auto; } " + ".contact-section input, .contact-section textarea { width: 100%; padding: 12px; margin-bottom: 1rem; border: 1px solid #ddd; border-radius: 5px; } " + ".site-footer { background: #1a2a3a; color: white; text-align: center; padding: 1.5rem; position: relative; bottom: 0; width: 100%; } " + "@media (max-width: 768px) { .hero-content h1 { font-size: 2rem; } section { padding: 60px 20px; } } ";
